...
?>
<link rel="stylesheet" href="/theme/css/customer.css">
<section>
    ...
    <div class="container">
        <div class="frm-step">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="them-du-an-moi-form" class="form-horizontal"
                      method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_csrf-frontend"
                           value="TQUzh7YaIttlnKZYECrXn_D_iXDH5gwsWfWo-XD_FFIbUl-z0SNHrQfl0A0lXrjInJzuIoaNWGUOgfiQPM1xPw==">
                    <p>
                        <b>Thông tin bắc buộc</b>
                    </p>
                    <div class="form-group field-dangkiktsstep02-name required">
                        <div class="col-sm-12">
                            <?= $form->field($project, 'title')->textInput([
                                'class' => 'form-control',
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group field-type1-id required">
                                <label class="control-label col-sm-4 col-md-4 col-lg-4" for="type1-id">
                                    Loại công trình
                                </label>
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'type_of_construction_id')->dropDownList(
                                        ArrayHelper::map(TypeOfConstruction::find()->asArray()->all(), 'id', 'title'), ['class' => 'form-control']
                                    )->label(false) ?>
                                    <p class="help-block help-block-error "></p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group field-subtype1-id">
                                <label class="control-label col-sm-4 col-md-4 col-lg-4" for="subtype1-id">
                                    Số tầng
                                </label>
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'floor')->textInput([
                                        'class' => 'form-control'
                                    ])->label(false) ?>
                                    <p class="help-block help-block-error "></p>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group field-dangkiktsstep02-style required">
                                <label class="control-label col-sm-4 col-md-4 col-lg-4" for="dangkiktsstep02-style">Style</label>
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'style')->dropDownList(
                                        ArrayHelper::map(Style::find()->asArray()->all(), 'id', 'title'), ['class' => 'form-control']
                                    )->label(false) ?>
                                    <p class="help-block help-block-error "></p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group field-dangkiktsstep02-hang_muc required">
                                <label class="control-label col-sm-4 col-md-4 col-lg-4"
                                       for="dangkiktsstep02-hang_muc">
                                    Hạng mục
                                </label>
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'category_project_id')->dropDownList(
                                        ArrayHelper::map(CategoryProject::find()->asArray()->all(), 'id', 'title'), ['class' => 'form-control']
                                    )->label(false) ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group field-cat1-id required">
                                ...
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'province_id')->dropDownList(
                        ...
                        <input type="hidden" id="input-type-1" name="input-type-1" value="769">
                        <input type="hidden" id="input-type-2" name="input-type-2" value="Additional value 2">
                        <div class="col-md-6">
                            <div class="form-group field-subcat1-id required">
                                ...
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'district_id')->dropDownList(
                                        ArrayHelper::map(District::find()->where(['=', 'province_id', $project->province_id])->all(), 'id', 'ten'),
                                        [
                        ...
                        <div class="col-md-6">
                            <div class="form-group field-subcat2-id">
                                ...
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'commune_id')->dropDownList(
                                        ArrayHelper::map(Commune::find()->where(['=', 'district_id', $project->district_id])->all(), 'id', 'ten'),
                                        [
                        ...
                        <div class="col-md-6">
                            <div class="form-group field-subcat3-id">
                                <label class="control-label col-sm-4 col-md-4 col-lg-4" for="subcat3-id">
                                    Địa chỉ
                                </label>
                                <div class="col-sm-8">
                                    <?= $form->field($project, 'address')->textInput(['class' => 'form-control', 'onchange' => 'getThongTinMaps(3)'])->label(false) ?>
                                    <p class="help-block help-block-error "></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="file-input file-input-ajax-new">
                                        ...
                                        <div class="file-thumbnail-footer">
                                            ...
                                            <div class="file-actions">
                                                <div class="file-footer-buttons">
                                                    <button type="button" <?= $project->isNewRecord ? '' : 'data-auto="1"' ?>
                                    ...
                                    <?php if (isset($images)): foreach ($images as $key => $value): ?>
                                        <div class="file-preview-frame krajee-default  kv-preview-thumb">
                                            ...
                                            <div class="file-thumbnail-footer">
                                                ...
                                                <div class="file-actions">
                                                    <div class="file-footer-buttons">
                                                        <button type="button" <?= $project->isNewRecord ? '' : 'data-auto="1" data-id="' . $value['id'] . '"' ?>
                                                                class="btn btn-xs btn-default"
                                                                onclick="deleteFile(event)">
                                                            <i class="fa fa-trash-o" aria-hidden="true"></i>
                                                        </button>
                                ...
                                <div class="spanButtonPlaceholder block-upload-item"
                                    ...
                                    <?php endif; ?>
                                    <?php if (!$project->isNewRecord): ?>
                                        <input data-auto="1" data-id="<?= $project['id'] ?>"
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type"
                                   class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="1">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group field-dangkiktsstep02-them_text">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'investor')->textInput(['class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group field-dangkiktsstep02-them_unit">
                                <div class="hidden">
                                    <input type="hidden" id="dangkiktsstep02-them_unit"
                                           class="form-control" name="DangKiKtsStep02[them_unit][]">
                                </div>
                            </div>
                            <div class="form-group field-number0">
                                <div class="hidden">
                                    <input type="hidden" id="number0" class="form-control"
                                           name="DangKiKtsStep02[them_number][]">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-0">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][0]"
                                           value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-0"
                                               name="DangKiKtsStep02[them_status][0]"
                                               value="1" data-toggle="toggle"
                                               data-onstyle="success"
                                               data-offstyle="default"
                                               data-size="mini" data-style="ios"
                                               data-on=" " data-off=" ">
                                        <div class="toggle-group">
                                            <label class="btn btn-success btn-xs toggle-on"> </label>
                                            <label class="btn btn-default btn-xs active toggle-off"> </label>
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type"
                                   class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="2">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class="control-label">Diện tích đất</label>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-number1">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'area_of_land')->textInput(['class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-1">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][1]"
                                           value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-1"
                                               name="DangKiKtsStep02[them_status][1]"
                                               value="1" data-toggle="toggle"
                                               data-onstyle="success"
                                               data-offstyle="default"
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type"
                                   class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="3">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group field-number2">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'design_area')->textInput(['class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-2">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][2]"
                                           value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-2"
                                               name="DangKiKtsStep02[them_status][2]"
                                               value="1" data-toggle="toggle"
                                               data-onstyle="success"
                                               data-offstyle="default"
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type" class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="4">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class="control-label">Giá trị công trình</label>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-number3">
                                <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group field-cc03">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'unit_id')->dropDownList(
                                        ArrayHelper::map(Unit::find()->asArray()->all(), 'id', 'title'), ['class' => 'form-control']
                                    )->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-3">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][3]" value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-3"
                                               name="DangKiKtsStep02[them_status][3]"
                                               value="1" data-toggle="toggle"
                                               data-onstyle="success"
                                               data-offstyle="default"
                                               data-size="mini" data-style="ios"
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type"
                                   class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="5">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class="control-label">Năm thiết kế</label>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-number4">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'year_of_design')->textInput(['class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-4">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][4]" value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-4"
                                               name="DangKiKtsStep02[them_status][4]"
                                               value="1" data-toggle="toggle" data-onstyle="success"
                                               data-offstyle="default"
                                               data-size="mini" data-style="ios"
                                               data-on=" " data-off=" ">
                                        <div class="toggle-group">
                    ...
                    <div class="form-group field-dangkiktsstep02-them_id_type">
                        <div class="hidden">
                            <input type="text" id="dangkiktsstep02-them_id_type"
                                   class="form-control"
                                   name="DangKiKtsStep02[them_id_type][]" value="6">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class="control-label">Năm hoàn thành</label>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-number5">
                                <div class="col-md-12">
                                    <?= $form->field($project, 'year_completed')->textInput(['class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1 padd-top-7px">
                            <div class="form-group field-dangkiktsstep02-them_status-5">
                                <div class="col-md-12 text-right">
                                    <input type="hidden"
                                           name="DangKiKtsStep02[them_status][5]"
                                           value="0">
                                    <div class="toggle btn btn-default off btn-xs ios" data-toggle="toggle"
                                         style="width: 29px; height: 4px;">
                                        <input type="checkbox"
                                               id="dangkiktsstep02-them_status-5"
                                               name="DangKiKtsStep02[them_status][5]"
                                               value="1" data-toggle="toggle"
                                               data-onstyle="success"
                                               data-offstyle="default"
                    ...
                    <p><b>Team design</b></p>
                    <div class="form-group field-dangkiktsstep02-id_friend">
                        <input type="hidden" id="dangkiktsstep02-id_friend" class="form-control"
                               name="DangKiKtsStep02[id_friend][]" value="3415">
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-4 col-md-4 col-lg-4" for="dangkiktsstep02-id_category">
                            Bạn là
                        </label>
                        <div class="col-sm-4">
                            <?= $form->field($project, 'position_id')->dropDownList(
                                ArrayHelper::map(Position::find()->asArray()->all(), 'id', 'title'), ['class' => 'form-control']
                            )->label(false) ?>
                            <p class="help-block help-block-error "></p>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group field-dangkiktsstep02-read required">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="checkbox">
                                        <label for="dangkiktsstep02-read">
                                            <input type="hidden" name="DangKiKtsStep02[read]" value="0">
                                            <input type="checkbox" id="dangkiktsstep02-read"
                                                   name="DangKiKtsStep02[read]" value="1" checked="">
                                            Ok. Tôi đã hiểu!
                                        </label>
                                    </div>
                                    <p class="help-block help-block-error "></p>
                    ...
                    <div class="form-group">
                        <div class="text-right col-md-12" style="margin-bottom: 15px">
                            <?= $form->field($project, 'images')->hiddenInput(['id' => 'images'])->label(false) ?>
                            <button onclick="getImages()" type="submit" class="btn btn-success" name="login-button">
                                Tạo dự án
                            </button>
                        </div>
                    </div>
