...
<script>var s2options_d6851687 = {
    ...
    <script type="text/javascript" charset="UTF-8" src="theme/js/common.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/util.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/map.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/marker.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/geometry.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/poly.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/onion.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/stats.js"></script>
<script type="text/javascript" charset="UTF-8" src="theme/js/controls.js"></script>
<script src="theme/js/jquery.js"></script>
<script src="theme/js/yii.js"></script>
<script src="theme/js/yii.validation.js"></script>
<script src="theme/js/select2.full.min.js"></script>
<script src="theme/js/select2-krajee.min.js"></script>
<script src="theme/js/vi.js"></script>
<script src="theme/js/kv-widgets.min.js"></script>
<script src="theme/js/dependent-dropdown.min.js"></script>
<script src="theme/js/depdrop.min.js"></script>
<script src="theme/js/bootstrap.js"></script>
<script src="theme/js/jquery.slimscroll.min.js"></script>
<script src="theme/js/jquery.easeScroll.js"></script>
<script src="theme/js/js(1)"></script>
<script src="theme/js/sortable.min.js"></script>
<script src="theme/js/purify.min.js"></script>
<script src="theme/js/fileinput.min.js"></script>
<script src="theme/js/vi.js(1)"></script>
<script src="theme/js/bootstrap-toggle.min.js"></script>
<script src="theme/js/yii.activeForm.js"></script>
<script src="theme/js/jquery.loading.min.js"></script>
<script src="theme/js/jquery.inputmask.bundle.js"></script>
<script src="theme/js/project.js"></script>
<script src="theme/js/javaChung.js"></script>
</script>
        ...
        <div class="frm-step">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div id="p0" data-pjax-container="" data-pjax-push-state="" data-pjax-timeout="1000">
                    <form id="thong-tin-tai-khoan-form" class="form-horizontal" method="post" data-pjax="1">
                        <input type="hidden" name="_csrf-frontend" value="wYQKL-7n_w2c29FaIFYE72tBvx3QzqrQzGbvTatzQ4-43ktMpbaNQt7snANGFHyEOy-Hc-mkwLGCEah97Rs7xw==">
                        <div class="form-group field-dangkiktsstep01-nick_name required has-success">
                            <label class="control-label col-sm-4 col-md-4 col-lg-4" for="dangkiktsstep01-nick_name">
                                Tên hiển thị
                            </label>
                            <div class="col-sm-6">
                                <input type="text" id="dangkiktsstep01-nick_name" class="form-control" name="DangKiKtsStep01[nick_name]" value="thuccao" placeholder="...." aria-required="true" aria-invalid="false">
                                <p class="help-block help-block-error "></p>
                            </div>

                        </div>
                        <div class="form-group field-dangkiktsstep01-first_name required has-error">
                            <label class="control-label col-sm-4 col-md-4 col-lg-4" for="dangkiktsstep01-first_name">
                                Họ tên đệm
                            </label>
                            <div class="col-sm-6">
                                <input type="text" id="dangkiktsstep01-first_name" class="form-control" name="DangKiKtsStep01[first_name]" placeholder="...." aria-required="true" aria-invalid="true">
                        ...
                        <div class="form-group field-dangkiktsstep01-last_name required">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="dangkiktsstep01-last_name" class="form-control" name="DangKiKtsStep01[last_name]" placeholder="...." aria-required="true">
                                <p class="help-block help-block-error "></p>
                            </div>
                        </div>
                        <div class="form-group field-dangkiktsstep01-sex">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div id="dangkiktsstep01-sex">
                                    <label class="radio-inline">
                                        <input type="radio" name="DangKiKtsStep01[sex]" value="1">
                                        Nam
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="DangKiKtsStep01[sex]" value="0" checked="">
                                        Nữ
                                    </label>
                                </div>
                                <p class="help-block help-block-error "></p>
                        ...
                        <div class="form-group field-dangkiktsstep01-phone required">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="dangkiktsstep01-phone" class="form-control" name="DangKiKtsStep01[phone]" placeholder="...." aria-required="true">
                                <p class="help-block help-block-error "></p>
                            </div>
                        ...
                        <div class="form-group field-cat1-id required">
                            ...
                            <div class="col-sm-6">
                                <select id="cat1-id" class="form-control select2-hidden-accessible" name="DangKiKtsStep01[idprovince]" onchange="js:getThongTinMaps(1)" aria-required="true" data-s2-options="s2options_d6851687" data-krajee-select2="select2_13e3f95f" style="display:none" tabindex="-1" aria-hidden="true">
                                ...
                                <span class="select2 select2-container select2-container--krajee" dir="ltr" style="width: 100%;">
                                    <span class="selection">
                                        <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-cat1-id-container">
                                            <span class="select2-selection__rendered" id="select2-cat1-id-container" title="Hồ Chí Minh">
                        ...
                        <input type="hidden" id="input-type-1" name="input-type-1"><input type="hidden" id="input-type-2" name="input-type-2" value="Additional value 2"><input type="hidden" id="input-type-lat" name="input-type-lat" value="10.765717635927077"><input type="hidden" id="input-type-lng" name="input-type-lng" value="106.68801789336294">
                        <div class="form-group field-subcat1-id required">
                            <label class="control-label col-sm-4 col-md-4 col-lg-4" for="subcat1-id">Chọn
                                quận/huyện</label>
                            <div class="col-sm-6">
                                <select id="subcat1-id" class="form-control select2-hidden-accessible" name="DangKiKtsStep01[iddistrict]" onchange="js:getThongTinMaps(2)" aria-required="true" data-krajee-depdrop="depdrop_39620606" data-s2-options="s2options_d6851687" data-krajee-select2="select2_b268a3e9" style="display:none" tabindex="-1" aria-hidden="true">
                                ...
                                </select><span class="select2 select2-container select2-container--krajee" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-subcat1-id-container"><span class="select2-selection__rendered" id="select2-subcat1-id-container"><span class="select2-selection__placeholder">Select ...</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                <p class="help-block help-block-error "></p>
                            </div>
                        ...
                        <div class="form-group field-subcat2-id">
                            ...
                            <div class="col-sm-6">
                                <select id="subcat2-id" class="form-control select2-hidden-accessible" name="DangKiKtsStep01[idward]" onchange="js:getThongTinMaps(3)" data-krajee-depdrop="depdrop_eda03ae1" data-s2-options="s2options_d6851687" data-krajee-select2="select2_b268a3e9" style="display:none" disabled="" tabindex="-1" aria-hidden="true">
                                    <option value="">Select ...</option>
                                </select><span class="select2 select2-container select2-container--krajee select2-container--disabled" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-subcat2-id-container"><span class="select2-selection__rendered" id="select2-subcat2-id-container"><span class="select2-selection__placeholder">Select ...</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                <p class="help-block help-block-error "></p>
                            </div>
                        ...
                        <div class="form-group field-subcat3-id">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="subcat3-id" class="form-control" name="DangKiKtsStep01[address]" onchange="js:getThongTinMaps(3)">
                                <p class="help-block help-block-error "></p>
                            </div>

                        </div>
                        <div class="clearfix"></div>
                        <div id="mapinfo_kts_p" style="min-height: 300px; margin-bottom: 20px; position: relative; overflow: hidden;">
                            <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                                <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                                        ...
                                        <div style="z-index: 1; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);">
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                    <div style="position: absolute; z-index: 985; transform: matrix(1, 0, 0, 1, -52, -43);">
                                            ...
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                                                ...
                                                <div style="width: 27px; height: 43px; overflow: hidden; position: absolute; left: -71px; top: -19px; z-index: 24;">
                                                    <img alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2.png" draggable="false" style="position: absolute; left: 0px; top: 0px; width: 27px; height: 43px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                            </div>
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                <div style="position: absolute; z-index: 985; transform: matrix(1, 0, 0, 1, -52, -43);">
                                                    <div style="position: absolute; left: 256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26096!3i15398!4i256!2m3!1e0!2sm!3i441146552!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=123025" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: 256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26096!3i15397!4i256!2m3!1e0!2sm!3i441146552!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=76445" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26095!3i15398!4i256!2m3!1e0!2sm!3i441146564!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=90425" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: 0px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26095!3i15397!4i256!2m3!1e0!2sm!3i441146564!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=43845" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: -512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26093!3i15397!4i256!2m3!1e0!2sm!3i441146588!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=109716" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26094!3i15398!4i256!2m3!1e0!2sm!3i441146576!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=57825" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: -512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26093!3i15398!4i256!2m3!1e0!2sm!3i441146588!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=25225" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                    <div style="position: absolute; left: -256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                        <img draggable="false" alt="" role="presentation" src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i15!2i26094!3i15397!4i256!2m3!1e0!2sm!3i441146576!3m14!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0!23i1301875&amp;key=AIzaSyD_FzZofFTP3vNGYR220_oGq9-mixLk4N8&amp;token=11245" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style="z-index: 3; position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px; touch-action: pan-x pan-y;">
                                            <div style="z-index: 4; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);">
                                                ...
                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;">
                                                    <div style="width: 27px; height: 43px; overflow: hidden; position: absolute; opacity: 0; left: -71px; top: -19px; z-index: 24;">
                                                        <img alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2.png" draggable="false" usemap="#gmimap2" style="position: absolute; left: 0px; top: 0px; width: 27px; height: 43px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                ...
                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 107; width: 100%;">
                                                    <div style="z-index: -202; cursor: pointer; display: none; touch-action: none;">
                                                        <div style="width: 30px; height: 27px; overflow: hidden; position: absolute;">
                                                            <img alt="" src="https://maps.gstatic.com/mapfiles/undo_poly.png" draggable="false" style="position: absolute; left: 0px; top: 0px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none; width: 90px; height: 27px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
                                        <a target="_blank" rel="noopener" href="https://maps.google.com/maps?ll=10.766729,106.690443&amp;z=15&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3" title="Click to see this area on Google Maps" style="position: static; overflow: visible; float: none; display: inline;">
                                    ...
                                    <div style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 16px; z-index: 10000002; display: none; width: 300px; height: 180px; position: absolute; left: 160px; top: 60px;">
                                    ...
                                    <div class="gmnoprint" style="margin: 10px; z-index: 0; position: absolute; cursor: pointer; left: 0px; top: 0px;">
                                        <div class="gm-style-mtc" style="float: left; position: relative;">
                                            ...
                                            <div style="background-color: white; z-index: -1; padding: 2px; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; position: absolute; left: 0px; top: 40px; text-align: left; display: none;">
                                                <div draggable="false" title="Show street map with terrain" style="color: rgb(0, 0, 0); font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 6px 8px 6px 6px; direction: ltr; text-align: left; white-space: nowrap;">
                                                    <span role="checkbox" style="box-sizing: border-box; position: relative; line-height: 0; font-size: 0px; margin: 0px 5px 0px 0px; display: inline-block; background-color: rgb(255, 255, 255); border: 1px solid rgb(198, 198, 198); border-radius: 1px; width: 13px; height: 13px; vertical-align: middle;"><div style="position: absolute; left: 1px; top: -2px; width: 13px; height: 11px; overflow: hidden; display: none;"><img alt="" src="https://maps.gstatic.com/mapfiles/mv/imgs8.png" draggable="false" style="position: absolute; left: -52px; top: -44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none; width: 68px; height: 67px;"></div></span><label style="vertical-align: middle; cursor: pointer;">Terrain</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gm-style-mtc" style="float: left; position: relative;">
                                            <div role="button" tabindex="0" title="Show satellite imagery" aria-label="Show satellite imagery" aria-pressed="false" draggable="false" style="direction: ltr; overflow: hidden; text-align: center; height: 40px; display: table-cell; vertical-align: middle; position: relative; color: rgb(86, 86, 86); font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 0px 17px; border-bottom-right-radius: 2px; border-top-right-radius: 2px; background-clip: padding-box; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; min-width: 66px; border-left: 0px;">
                                                Satellite
                                            </div>
                                            <div style="background-color: white; z-index: -1; padding: 2px; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; position: absolute; right: 0px; top: 40px; text-align: left; display: none;">
                                                <div draggable="false" title="Show imagery with street names" style="color: rgb(0, 0, 0); font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 6px 8px 6px 6px; direction: ltr; text-align: left; white-space: nowrap;">
                                                    <span role="checkbox" style="box-sizing: border-box; position: relative; line-height: 0; font-size: 0px; margin: 0px 5px 0px 0px; display: inline-block; background-color: rgb(255, 255, 255); border: 1px solid rgb(198, 198, 198); border-radius: 1px; width: 13px; height: 13px; vertical-align: middle;"><div style="position: absolute; left: 1px; top: -2px; width: 13px; height: 11px; overflow: hidden;"><img alt="" src="https://maps.gstatic.com/mapfiles/mv/imgs8.png" draggable="false" style="position: absolute; left: -52px; top: -44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none; width: 68px; height: 67px;"></div></span><label style="vertical-align: middle; cursor: pointer;">Labels</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
