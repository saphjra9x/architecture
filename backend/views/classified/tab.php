...
/* @var $classified \common\models\Post */
...
<div class="page-content " style="min-height: 602px;">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?= Url::to( [ 'setting/tab', 'post_id' ] ) ?>">
				<?= $classified['title'] ?>
            </a>
        </li>
        ...
        <div class="text-center col-xs-12">
            ...
            <div class="empty-displayTmpl-btn">
                <a class="btn btn-success"
                   href="<?= Url::to( [ 'tab/create', 'parent_id' => $classified['id'], 'table' => 'classified' ] ) ?>">
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <a href="<?= Url::to( [ 'tab/update', 'id' => $value['id'] ] ) ?>"
                                                   class="btn btn-icon btn-sm btn-primary tip">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="btn btn-icon btn-sm btn-danger deleteDialog tip"
                                                   data-toggle="modal"
                                                   data-section="https://cms.botble.com/admin/menus/delete/10"
                                                   role="button"
                                                   data-original-title="Xóa bản ghi">
