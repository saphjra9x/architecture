...
/* @var $classifieds array common\models\Classified */
	...
	<?php if ( ! count( $classifieds ) ): ?>
        <div class="text-center col-xs-12">
            ...
            <p class="text-info-displayTmpl">
                Thêm tin rao cho website để hiện thị các thông tin hiệu quả.
            </p>
            ...
            <div class="empty-displayTmpl-btn">
                <a class="btn btn-success" href="<?= Url::to( [ 'wait-create' ] ) ?>">
                    ...
                    <div class="table-responsive">
                        <div id="table-menus_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="dt-buttons btn-group">
                                <a class="btn btn-default action-item" href="<?= Url::to( [ 'wait-create' ] ) ?>">
                                <span>
                                    <span>
                                ...
                                <a class="btn btn-default buttons-reload" href="<?= Url::to( [ 'wait-index' ] ) ?>">
                            ...
                            <table class="table table-striped table-hover vertical-middle dataTable no-footer">
                                ...
                                <tr role="row">
                                    ...
                                    <th width="100px" class="no-sort column-key-updated_at sorting_disabled" rowspan="1"
                                        colspan="1" style="width: 100px;" aria-label="Chuyên mục">Chuyên mục
                                    </th>
                                    <th width="100px" class="column-key-status sorting" tabindex="0"
                                        aria-controls="table-menus" rowspan="1" colspan="1" style="width: 100px;"
                                        aria-label="Trạng tháiorderby asc">Duyệt
                                    </th>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="column-key-status">
                                            <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-mini"
                                                ...
                                                <input data-id="<?= $value['id'] ?>" data-api="ajax/enable-column"
                                                       data-table="classified" data-column="status"
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <a href="<?= Url::to( [ 'wait-update', 'id' => $value['id'] ] ) ?>"
