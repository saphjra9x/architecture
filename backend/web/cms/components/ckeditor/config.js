...
CKEDITOR.editorConfig = function (config) {
    ...
    config.width = 'auto';
    config.filebrowserBrowseUrl = '/uploads/library/filemanager/dialog.php?type=2&editor=ckeditor&fldr=';
    config.filebrowserUploadUrl = '/uploads/library/filemanager/dialog.php?type=2&editor=ckeditor&fldr=';
    config.filebrowserImageBrowseUrl = '/uploads/library/filemanager/dialog.php?type=1&editor=ckeditor&fldr=';
